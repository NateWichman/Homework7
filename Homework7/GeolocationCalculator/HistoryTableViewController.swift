   ...
   /* override func viewWillDisappear(_ animated: Bool)
    {
        ...
        if let d = delegate
        {
            d.selectEntry(entry: LocationLookup(origLat: 1, origLng: 1, destLat: 2, destLng: 2, timestamp: Date()))
        }
    } */
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        // Configure the cell...
            ...
            cell.textLabel?.text = "(\(entries[indexPath.row].origLat),\(entries[indexPath.row].origLng))(\(entries[indexPath.row].destLat),\(entries[indexPath.row].destLng))"
